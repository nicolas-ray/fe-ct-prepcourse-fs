...
var suma = resultadosTest.reduce((suma, num) => suma + num, 0);
...
function multiplicarArgumentos() {
   ...
   if (arguments.length === 0) {
      ...
      return arguments[0]; // Si se pasó un argumento, retornarlo tal cual
  } else {
      // Si se pasaron múltiples argumentos, multiplicarlos entre sí
      let producto = 1;
...
function todosIguales(array) {
   ...
   // Si llega hasta aquí, todos los elementos son iguales
   return true;
}
